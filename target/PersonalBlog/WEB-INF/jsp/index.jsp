    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="blogerinfo my-4">
                ...
                <p class="blogerinfo-nickname">Peterxiazhen</p>
                <p class="blogerinfo-introduce">Just be yourself.</p>
                <!--<hr>-->
                <div class="blogerinfo-contact">
                    <a target="_blank" id="qq" title="QQ交流"
                       href="http://wpa.qq.com/msgrd?v=3&uin=1040412138&site=qq&menu=yes"><i
                            class="fa fa-qq fa-2x"></i></a>
                    <a target="_blank" id="github" title="Github" href="https://github.com/Peterxiazhen"><i
...
<footer class="py-3" style="background-color: white; border-top: 1px solid #f0f0f0">
    <div class="container">
        <p class="m-0 text-center" style="color: #c8c8c8;">Copyright &copy; Blog 2021</p>
    </div>
</footer>
